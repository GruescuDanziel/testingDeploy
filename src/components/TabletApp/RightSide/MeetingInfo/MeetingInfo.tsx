...
const MeetingInfo = ({ setSelectedCardId }: iMeetingInfo) => {
    ...
    const getMeetingById = async (meetid: string) => {
        const result = await axios.get(
            `http://10.152.20.113:3001/roomData/`
        );
    ...
    return meetingData ? (
        ...
        >
            ...
            <Grid item xs={12}>
                <Grid container direction={"row"} marginTop={0}>
                    <Grid item xs={3}>
            ...
            <Grid item xs={12}>
                <Grid container direction={"row"}>
                    <Grid item xs={3} marginTop={5} marginLeft={1}>
                        <Typography variant="h5">Description</Typography>
                    </Grid>
                </Grid>
            </Grid>
            <Grid item xs={12}>
                <Grid padding={0.5} container direction={"row"} marginTop={-1}>
                    <Grid item xs={14} marginLeft={1} wrap={'wrap'} md={10} lg={3}>
